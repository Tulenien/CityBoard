...
import com.CityBoard.IRequestsRepository;
import com.CityBoard.RequestsRepository;
...
public class RequestsService {
    private final IRequestsRepository requestsRepository;
    ...
    public boolean createRequest(Long userId, Long advertId, RequestType type) {
        return requestsRepository.createRequest(userId, advertId, type);
    }

    public List<Requests> getIncomingRequests(Long userId) {
        return requestsRepository.findIncoming(userId);
    }

    public List<Requests> getOutgoingRequests(Long userId) {
        return requestsRepository.findOutgoing(userId);
    }
    ...
    public boolean changeRequestStatus(Long requestId, RequestStatus status) {
        return requestsRepository.updateRequestStatus(requestId, status);
    }

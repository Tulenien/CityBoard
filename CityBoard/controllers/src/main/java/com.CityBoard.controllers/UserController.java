...
public class UserController {
    ...
    public String registerUser(UserCredentialsDTO dto, BindingResult bindingResult, Model model) {
    ...
    public String hideAdvert(@RequestParam(value = "id") Long advertId, Principal principal) {
        if (noRegUI.isUserAuthenticated())
        {
            ...
            if (user != null) {
                Adverts advert = clientUI.viewAdvert(advertId);
                if (advert != null && advert.getUser().getUsername().equals(principal.getName())) {
